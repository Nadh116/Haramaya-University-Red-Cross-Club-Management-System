                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                        <div className="text-center animate-fade-in">
                            ...
                            <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-slide-up">
                                Haramaya University
                                <span className="block text-red-cross-200 animate-slide-up animate-stagger-1">Red Cross Club</span>
                            </h1>

                            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate-slide-up animate-stagger-2 text-white/90">
